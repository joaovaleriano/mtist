...
mu.GLOBALS.MASTER_DATASET_DIR = "master_datasets_copy"
mu.GLOBALS.MTIST_DATASET_DIR = "mtist_datasets_copy"
...
# Inference with arithmetic mean
for inference_type, prefix, handle in zip(inference_names, prefixes, inference_fxn_handles):
    print(inference_type+"_arithm")
    im.INFERENCE_DEFAULTS.INFERENCE_PREFIX = prefix+"arithm_"
    im.INFERENCE_DEFAULTS.INFERENCE_FUNCTION = handle
    _ = im.infer_and_score_all(save_inference=True, save_scores=True, arithm_mean=True)
